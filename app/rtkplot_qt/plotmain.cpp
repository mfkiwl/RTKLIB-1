...
void Plot::LoadOpt(void)
{
    ...
    MColor[0][1]=settings.value("plot/mcolor1", QColor(0x00,0x80,0x00)).value<QColor>();
    MColor[0][2]=settings.value("plot/mcolor2", QColor(0xFF,0xAA,0x00)).value<QColor>();
    MColor[0][3]=settings.value("plot/mcolor3", QColor(0xff,0x00,0xff)).value<QColor>();
    MColor[0][4]=settings.value("plot/mcolor4", QColor(0x00,0x00,0xff)).value<QColor>();
    MColor[0][5]=settings.value("plot/mcolor5", QColor(0xff,0x00,0x00)).value<QColor>();
    MColor[0][6]=settings.value("plot/mcolor6", QColor(0x00,0x80,0x80)).value<QColor>();
    ...
    MColor[1][1]=settings.value("plot/mcolor9", QColor(0x00,0x40,0x80) ).value<QColor>();
    MColor[1][2]=settings.value("plot/mcolor10",QColor(0x80,0x80,0x00) ).value<QColor>();
    MColor[1][3]=settings.value("plot/mcolor11",QColor(0x80,0x00,0xFF) ).value<QColor>();
    MColor[1][4]=settings.value("plot/mcolor12",QColor(0x00,0x80,0xFF) ).value<QColor>();
    MColor[1][5]=settings.value("plot/mcolor13",QColor(0xFF,0x80,0x80) ).value<QColor>();
    MColor[1][6]=settings.value("plot/mcolor14",QColor(0x80,0x80,0xFF) ).value<QColor>();
